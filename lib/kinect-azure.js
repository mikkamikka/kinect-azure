...
console.log('!!== This a local FF kinect-azure module ==!!');
...
class KinectAzure {
  ...
  nuitrackInit() { return kinect.nuitrackInit() }
  nuitrackUpdate() { return kinect.nuitrackUpdate() }
  ...
  setTemporalSmooting(smoothing_factor) { return kinect.setTemporalSmooting(smoothing_factor) }
...

{
  ...
  KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_CUDA = 2;     
  KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_TENSORRT = 3;
  KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_DIRECTML = 4;
}
